...
### *haar_integral*
Takes in a tuple of sequences $((i_1,\dots,i_p),\quad (j_1,\dots,j_p),\quad (i_1\prime,\dots, i_p\prime),\quad (j_1\prime,\dots,j_p\prime))$, and the dimension $d$ of the unitary group. Returns the value of the integral $\int dU\; U_{i_1j_1}\dots U_{i_pj_p}U^\ast_{i_1\prime j_1\prime}\dots U^\ast_{i_p\prime j_p\prime}$.
```Python
