...
### *haar_integral*
Takes in a tuple of sequences $((i_1,\dots,i_p),\, (j_1,\dots,j_p),\, (i\prime_1,\dots, i\prime_p),\, ({j\prime}_1,\dots,j\prime_p))$, and the dimension $d$ of the unitary group. Returns the value of the integral $\int dU\, U_{i_1j_1}\dots U_{i_pj_p}U^\ast_{i\prime_1 j\prime_1}\dots U^\ast_{i\prime_p j\prime_p}$.
```Python
