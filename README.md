...
### *haar_integral*
Takes two strings, $\mathbf{i}$ and $\mathbf{j}$, and the dimension $d$ of the unitary group and returns the value of the integral $\int dU U_{i_1i_2}\dots U_{i_{p-1}i_p}U^\ast_{j_1j_2}\dots U^\ast_{j_{p-1}j_p}$. The input paramaters are, in order, ${i_1,\dots,i_p}$ and ${j_1,\dots,j_p}$, the two strings of indices, and $d$, the dimension of the unitary group. 
```Python
