...
### *haar_integral*
Takes two strings, $\mathbf{i}$ and $\mathbf{j}$, and the dimension $d$ of the unitary group and returns the value of the integral $\int dU\,U_{i_1i_2}\dots U_{i_{p-1}i_p}U_{j_1j_2}\dots U_{j_{p-1}j_p}$.
```Python
